...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    //fint the mathcing task list item
    ...
    // loop trhough tasks array an dtask object with new content
...
var editTask = function(taskId) {
    ...
    document.querySelector("#save-task").textContent = "Save Work";
...
/* 1. Gets task items from Local Storage
    ...
    for (var i = 0; i < savedTasks.length; i++) {
       ...
       // console.log(taskIdCounter);
        ...
        taskInfoEl.className = "task-info";
         ...
         var taskActionsEl = createTaskActions(savedTasks[i]);
